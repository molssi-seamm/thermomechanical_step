...
class Thermomechanical(seamm.Node):
    ...
    def __init__(
        ...
        namespace="org.molssi.seamm.thermomechanical",
        extension=None,
        logger=logger
    ):
    ...
    def description_text(self, P=None):
        ...
        while node is not None:
            try:
                ...
                print(
                    "Unexpected error describing thermomechanical flowchart: {} in {}"
    ...
    def run(self):
        ...
        result = local.run(
            cmd=["Thermomechanical", "-in", "molssi.dat"],
            files=files,
            return_files=[]
        )  # yapf: disable

        if result is None:
            logger.error("There was an error running Thermomechanical")
            return None
